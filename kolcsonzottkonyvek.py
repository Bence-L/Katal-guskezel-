...
def kolcson():
    ...
    proba = tk.Label(kolcson, text="Könyvek", bg="#9A7E6F", fg="#493628", font=('sans', 70, 'bold'))
    ...
    listBox = ttk.Treeview(kolcson, columns=cols, show='headings')
    ...
    showScores = tk.Button(kolcson, text="Adatok mutatása",  fg="#493628", bg="#D6C0B3", font="sans 13 bold", command=show)
    showScores.grid(row=4, column=0, padx=(480, 100))

    closeButton = tk.Button(kolcson, text="Vissza", fg="#493628", bg="#FF8A8A", font="sans 13 bold", command=kolcson.destroy)
