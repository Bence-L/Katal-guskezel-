...
def adminegesz():
    ...
    lekerdezes = Button(Akezdo, text ="Lekérdezés", bg="#D6C0B3", font="sans 20 bold",  borderwidth=16, command=LekerdezesNyitas).grid(row= 1, pady=4,padx=200)
    módosítás = Button(Akezdo, text ="Módosításs", bg="#D6C0B3", font="sans 20 bold",  borderwidth=16, command=ModositasNyitas).grid(row= 2, pady=4,padx=200)
    hozzáadás = Button(Akezdo, text ="Hozzáadás", bg="#D6C0B3", font="sans 20 bold",  borderwidth=16, command=HozzaadasNyitas).grid(row= 3, pady=4,padx=200)
    törlés = Button(Akezdo, text ="Törlés", bg="#D6C0B3", font="sans 20 bold",  borderwidth=16, command=TorlesNyitas).grid(row= 4, pady=4,padx=200)
    bezárás = Button(Akezdo, text ="Bezárás", bg="#C7253E", font="sans 16 bold",  borderwidth=16).grid(row= 5, pady=30,padx=200)
