...
lekerdezes = Button(Akezdo, text ="Lekérdezés", bg="#9A7E6F", font="sans 20 bold",  borderwidth=16).grid(row= 1, pady=4,padx=200)
módosítás = Button(Akezdo, text ="Módosítás", bg="#9A7E6F", font="sans 20 bold",  borderwidth=16).grid(row= 2, pady=4,padx=200)
hozzáadás = Button(Akezdo, text ="Hozzáadás", bg="#9A7E6F", font="sans 20 bold",  borderwidth=16).grid(row= 3, pady=4,padx=200)
törlés = Button(Akezdo, text ="Törlés", bg="#9A7E6F", font="sans 20 bold",  borderwidth=16).grid(row= 4, pady=4,padx=200)
