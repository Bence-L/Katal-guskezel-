...
def adminegesz():
    ...
    konyvek = Button(Akezdo, text ="Könyvek", bg="#D6C0B3", fg="#493628",font="sans 20 bold",  borderwidth=3, width= 40, height=3, command=ADMINKONYV).grid(row= 1, pady=4,padx=10)
    ...
    módosítás = Button(Akezdo, text ="Módosításs", bg="#D6C0B3",fg="#493628", font="sans 20 bold",  borderwidth=3, width= 40, height=3, command=ModositasNyitas).grid(row= 3, pady=4,padx=16)
    ...
    törlés = Button(Akezdo, text ="Törlés", bg="#D6C0B3", fg="#493628",font="sans 20 bold",  borderwidth=3, width= 40, height=3, command=TorlesNyitas).grid(row= 5, pady=5,padx=6)
    bezárás = Button(Akezdo, text ="Bezárás", bg="#FF8A8A", font="sans 16 bold",  borderwidth=10).grid(row= 6, pady=30,padx=200)
